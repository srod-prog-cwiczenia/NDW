...
%%%@@@ old notation and just below the new one
...
\end{abstract}
\subjclass[2010]{54H05, 03E05, 11B05, 11A41}
\keywords{ideals, Furstenberg's topology, Golomb's topology, Kirch's topology,
Marczewski-Burstin representability}
\maketitle
...
%%%%@@@ part removed by the Referee comment 
%%%
%%%
%\begin{prop}
...
%%%%%%@@@ moved over Example 2.4 - beginning of the part
\begin{thm}
$\I_K \subseteq \I_G$.
\end{thm}
...
\end{proof}
%%%%%%@@@ moved over Example 2.4 - end of the part
...
\end{itemize}
%%%@@@ superfluous since the proof works for T_K:
...
%%%@@@ Removed by Referee's comment: "There doesn't seem to be any motive for including Proposition
%%% 2.7" 
